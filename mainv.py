...
st.text("There is a sharp drop in inertia when moving from 2 to 3 clusters, and another noticeable decrease from 3 to 4 clusters. After that, the rate of decrease becomes more gradual. Therefore, the elbow seems to be around K=3 or K=4.
